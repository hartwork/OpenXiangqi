...
public class Adviser extends Piece {
	...
	protected PlayerRelativeLocation calculateMoveTarget(PlayerRelativeMove move)
		...
		PlayerRelativeLocation candidate = calculateMoveTargetCross(move, 1);
		if (!candidate.isInsidePalace()) {
			throw new PieceMustNotLeavePalace();
		}
		return candidate;
	}
